        ...
        <View style={styles.container}>
            ...
            <View style={styles.paymentContainer}>
                <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    ...
                    <Text style={{marginLeft:15, marginBottom:3, fontSize:16}}>Cash</Text>
                </View>
            ...
            <View style={styles.profileContainer}>
                <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    ...
                    <Text style={{marginLeft:15, fontSize:16, fontWeight:'500'}}>Personal</Text>
                </View>
                <Ionicons color="grey" size={23} name="ios-arrow-forward" />
            </View>
            <View style={styles.profileContainer2}>
                <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    ...
                    <Text style={{marginLeft:15, fontSize:16, fontWeight:'500'}}>{"Ride for business"}
                      <Text style={{fontWeight:'normal', fontSize:13, color:'grey'}}>{'\nEnable business for featured travel'}</Text>
                    </Text>
                </View>
                <Ionicons color="grey" size={23} name="ios-arrow-forward" />
            </View>
            ...
            <View style={styles.paymentContainer2}>
                <View  style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    ...
                    <Text style={{marginLeft:15, marginBottom:13, fontSize:15}}>Uber Cash</Text>
                </View>
                <Ionicons color="grey" size={23} name="ios-arrow-forward" />
            </View>
            ...
            <View style={styles.paymentContainer2}>
                <View style={{flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    <View style={styles.uberCash}>
                        <MaterialCommunityIcons name="ticket-confirmation" color="white" size={16} />
                    </View>
